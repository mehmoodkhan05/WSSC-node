          ...
          <DialogContent style={styles.dialogContent}>
            <View style={styles.form}>
              ...
              <View style={styles.mapPlaceholder}>
                <Text style={styles.mapPlaceholderTitle}>Need a map pin?</Text>
                <Text style={styles.mapPlaceholderText}>
                  Use the WSSC Management mobile app to drop a marker on the interactive map. The
                  selected latitude and longitude will sync with these fields automatically.
                </Text>
                <Text style={styles.mapPlaceholderHelper}>
                  Tip: You can still paste coordinates from Google Maps if you are working strictly
                  from the browser.
                </Text>
              </View>
